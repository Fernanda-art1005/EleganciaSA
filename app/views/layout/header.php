...
if (!function_exists('getProductImageUrl')) {
    function getProductImageUrl($nome) {
        ...
        } elseif (strpos($term, 'blazer') !== false || strpos($term, 'casaco') !== false || strpos($term, 'paletó') !== false || strpos($term, 'paleto') !== false || strpos($term, 'jaqueta') !== false) {
