                    ...
                    <?php foreach ($alertasEstoque as $produto): ?>
                        <div class="flex items-center justify-between p-3 bg-rose-50/50 hover:bg-rose-50 border border-rose-100/50 rounded-xl transition-all">
                            <div class="overflow-hidden">
                                <p class="text-sm font-semibold text-gray-700 truncate" title="<?= htmlspecialchars($produto['nome']) ?>"><?= htmlspecialchars($produto['nome']) ?></p>
                                <p class="text-[10px] text-gray-400">Estoque mínimo: <span class="font-semibold text-gray-500 font-mono"><?= $produto['estoque_minimo'] ?> unid</span></p>
                            </div>
                            <div class="text-right ml-3 shrink-0">
                                <span class="inline-block text-xs font-bold text-rose-600 bg-rose-100 px-2.5 py-1 rounded-lg font-mono">
                                    <?= $produto['quantidade'] ?>
                                </span>
                            </div>
                        </div>
                        ...
                        ?>
                            <tr class="hover:bg-[#F5F5F0]/50 transition-all">
                                ...
                                <td class="py-3.5 px-4 text-right">
                                    <a href="<?= $basePath ?>/crm" class="px-3 py-1.5 border border-[#C4BC96]/35 text-[#BAAE79] hover:bg-[#8DA574] hover:text-white rounded-lg font-medium shadow-sm transition-all duration-150 inline-flex items-center gap-1">
